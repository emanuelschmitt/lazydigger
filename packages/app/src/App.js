...
const config = {
  ...
  onSearch: async (state) => {
    ...
    const responseJsonWithDisjunctiveFacetCounts = await applyDisjunctiveFaceting(responseJson, state, [
      'visitors',
      'states',
    ]);
              ...
              <Layout
                ...
                sideContent={
                  <div>
                    ...
                    <Facet field="genres" label="Genres" filterType="any" isFilterable={true} />
                    <Facet field="styles" label="Styles" filterType="any" isFilterable={true} />
